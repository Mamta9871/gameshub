...
function preload() {
    foodImage = loadImage("/public/images/food.png");
    ratImage = loadImage("/public/images/rat.png");

    moveSound = loadSound("/public/audio/moves.wav");
    difficultySound = loadSound("/public/audio/difficulty.wav");
    winSound = loadSound("/public/audio/win.mp3");
}
